...
public interface StorageApi {
    ...
    ResponseEntity<FileUploadResponseDto> uploadFile(MultipartFile file) throws Exception;
    ...
    ResponseEntity<Void> deleteFile(FileDeleteRequestDto request) throws Exception;
}